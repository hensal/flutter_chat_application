...
import 'package:chat_application/openpdf.dart';
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () {
                      ...
                      _sendMessage(
                          imageBytes:
                              imageBytes); // Pass the imageBytes to _sendMessage
                    },
                  ),
                ],
              ),
  ...
  void _scrollToBottom() {
    if (_scrollController.hasClients) {
      ...
      _scrollController.animateTo(
        position + 550, // Adjust the 100 if necessary
                    ...
                    child: Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment
                            .end, // Aligns timestamp to the right inside the container
                        mainAxisSize:
                            MainAxisSize.min, // Avoids unnecessary empty space
                        children: [
                          if (imageBytes != null)
                            Image.memory(
                              imageBytes,
